...
public class Covert_ImagesTo_GIF {
	...
	static final String[] EXTENSIONS = new String[] { "png"  //(, "bmp") use the code in brackets to add more extension 
	};
		...
		for (int i = 1; i <= count; i++) {
			try {
				Files.deleteIfExists(Paths
						.get("F://SoftInstall//Selenium eclipse//Selenium SS//Screenshot"
								+ i + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
