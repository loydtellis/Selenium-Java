...
public class FlipkartUI_Tesing {
	...
	public void testPass() throws Exception {
		...
		String a=  driver.findElement(By.cssSelector(".\\_2pi5LC:nth-child(2) .\\_4rR01T")).getText();
		System.out.println(a);
		driver.findElement(By.cssSelector(".\\_2pi5LC:nth-child(2) .\\_4rR01T")).click();
		Thread.sleep(2000);
		...
		String b = driver.findElement(By.cssSelector(".B_NuCI")).getText();
		...
		String aa=driver.findElement(By.linkText("Samsung Galaxy F41 (Fusion Blue, 128 GB)")).getText();
		System.out.println(aa);
		
		if (a.equals(aa)) {
			driver.findElement(By.cssSelector(".\\_2ObVJD > span")).click();
			Thread.sleep(3000);
			count++;
			getscreenshot(count);
